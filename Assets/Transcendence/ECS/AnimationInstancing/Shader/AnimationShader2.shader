Shader "Transcendence/AnimationShader2"
{
    Properties
    {
    ...
    CGINCLUDE
        ...
        void vert (inout appdata_full v) {
            ...
            float scaledTime = _Time.y * currentAnimation.z + phase * currentAnimation.a;
            float loopTime = fmod(scaledTime, currentAnimation.a);
            
            float xCoord = v.color.r;
            float yCoord = v.color.g;
            
            float2 uv = float2(loopTime+xCoord, yCoord) + offset;
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Smoothness = 1 - tex2D(_SpecGlossMap, IN.uv_SpecGlossMap);
        }
        ENDCG
    }
    FallBack "Diffuse"
